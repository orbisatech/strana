...
export default function Events() {
  return (
    <section id="eventos" style={{ background: 'var(--black)', borderTop: '1px solid var(--border)' }}>
      <style>{`
        .event-hero { position: relative; height: 90vh; overflow: hidden; }
        .event-body { display: grid; grid-template-columns: 1fr 1fr; border-top: 1px solid var(--border); }
      ...
      <div className="event-hero">
        ...
        <div style={{ position: 'absolute', top: '2rem', left: '2.5rem', background: 'var(--gold)', color: 'var(--black)', fontSize: '0.6rem', letterSpacing: '0.2em', textTransform: 'uppercase', padding: '0.35rem 1rem', fontWeight: 600 }}>Opening Week</div>
        <div style={{ position: 'absolute', bottom: '3rem', left: '2.5rem', right: '2.5rem' }}>
          <p style={{ fontSize: '0.6rem', letterSpacing: '0.28em', textTransform: 'uppercase', color: 'var(--gold)', marginBottom: '0.8rem' }}>Guadalajara · Grand Opening</p>
          <h3 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 'clamp(3rem, 8vw, 8rem)', lineHeight: 0.9, letterSpacing: '0.02em', color: 'var(--white)', marginBottom: '1.5rem' }}>OPENING<br />WEEK</h3>
      ...
      <div className="event-body">
        <div style={{ borderRight: '1px solid var(--border)' }}>
          <div style={{ padding: '2rem 2.5rem 1rem' }}>
            <p style={{ fontSize: '0.58rem', letterSpacing: '0.25em', textTransform: 'uppercase', color: 'var(--gold)' }}>Headliner</p>
          </div>
