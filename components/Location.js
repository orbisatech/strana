  ...
  return (
    <section id="ubicacion" style={{ padding: '5rem 0', borderTop: '1px solid var(--border)' }}>
      ...
      <div style={{ padding: '0 1.5rem', marginBottom: '2rem' }}>
        <h2 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: '3rem', letterSpacing: '0.06em', color: 'var(--white)' }}>
          Ubicación
        </h2>
      </div>
      ...
      <div style={{ height: '380px', position: 'relative', overflow: 'hidden' }}>
        <iframe
          ...
          style={{ border: 'none', filter: 'grayscale(1) invert(1) contrast(0.9) brightness(0.8)' }}
          loading="lazy"
