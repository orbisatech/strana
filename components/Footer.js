...
const IconInstagram = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><rect x="2" y="2" width="20" height="20" rx="5.5" stroke="currentColor" strokeWidth="1.5"/><circle cx="12" cy="12" r="4.5" stroke="currentColor" strokeWidth="1.5"/><circle cx="17.5" cy="6.5" r="1" fill="currentColor"/></svg>
)
const IconTikTok = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M9 12a4 4 0 1 0 4 4V4a5 5 0 0 0 5 5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
)
const IconFacebook = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
)
  ...
  return (
    <footer id="redes" style={{ borderTop: '1px solid var(--border)', padding: '3rem 1.5rem' }}>
        ...
        <div style={{ display: 'flex', gap: '1.8rem', alignItems: 'center' }}>
          {SOCIALS.map(({ name, url, Icon }) => (
            <a key={name} href={url} target="_blank" rel="noopener noreferrer" title={name}
              style={{ color: 'var(--dim)', textDecoration: 'none', transition: 'color 0.3s, transform 0.3s', display: 'flex', alignItems: 'center' }}
      ...
      <div className="footer-bottom">
        {/* Copyright + link discreto al admin */}
        <div style={{ display: 'flex', alignItems: 'center', gap: '1.2rem' }}>
          <p style={{ fontSize: '0.6rem', color: 'var(--dim)', letterSpacing: '0.1em' }}>
            © STRANA GDL 2025. Todos los derechos reservados.
          </p>
          <a href="/admin"
            style={{ fontSize: '0.55rem', color: 'rgba(240,237,230,0.12)', letterSpacing: '0.12em', textDecoration: 'none', transition: 'color 0.4s' }}
